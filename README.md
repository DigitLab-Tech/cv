...
| Projets | Description |
| :------------: | :------------ |
| Enseignement | L'enseignement est nouveau défi pour moi. Pour le moment mes réalisations y sont minime. J'y met tout cœur. J'ai produit l'intégralité du contenu de mon cours. J'offre beaucoup de disponibilité. Je crois offrir un bon niveau de rétroaction. Je consulte mes collègues concernant le contenu de mon cours. Je participe à des ateliers de perfectionnement. | 
